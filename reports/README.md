...
This directory contains the editable source files, references, figures, and build resources for the **Bangladesh AI Policy & Innovation Lab (BAPIL)** publications.

## Contents

| File/Directory | Description |
|---------------|-------------|
| `BAPIL_Executive_Summary_v1.md` | English Executive Summary source (Version 1.0) |
| `BAPIL_Executive_Summary_v1_bn.md` | Bangla Executive Summary source (Version 1.0) |
